...
The system contains also the AI-assisted features to enhance the supervision process. The supervisor recommendation module assists in recommending appropriate supervisors, based on the similarity between proposal topics and supervisors' research interests, as well as supervisor workload. The proposal analysis module applies the Natural Language Processing (NLP) techniques to verify whether the proposals have significant sections like introduction, problem statement, objectives and methodology. It also includes a chatbot assistant that will respond to the most frequently asked questions related to FYP, as well as guide users in the process of using the system.
