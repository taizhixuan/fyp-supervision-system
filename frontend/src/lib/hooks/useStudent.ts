...
export const studentKeys = {
  ...
  supervisorList: (filters?: object) => [...studentKeys.supervisors(), 'list', filters] as const,
  ...
  meetingList: (filters?: object) => [...studentKeys.meetings(), 'list', filters] as const,
  ...
  logList: (filters?: object) => [...studentKeys.logs(), 'list', filters] as const,
  logDetail: (id: string) => [...studentKeys.logs(), 'detail', id] as const,
  documents: () => [...studentKeys.all, 'documents'] as const,
  documentList: (filters?: object) => [...studentKeys.documents(), 'list', filters] as const,
