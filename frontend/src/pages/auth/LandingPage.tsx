        ...
        <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-[#1e3a5f] to-[#0f1f33]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100/80 mb-8 max-w-2xl mx-auto leading-relaxed">
              Create an account to access AI supervisor matching, proposal analysis, and progress tracking. New registrations are reviewed and approved before first sign-in.
            </p>
